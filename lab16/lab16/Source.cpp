...
void program2() {
	int i, n;
	double a, d;
	cout << "2. Программа по заданному целому числу N > 1, перовму члену A и знаменателю D геометрической прогрессии сформирует и выведет массив размера N, содержащий N первых членов данной прогрессии: A, A*D, A*D*D, ...\n";
	cout << "Задайте значение N: ";
	cin >> n;
